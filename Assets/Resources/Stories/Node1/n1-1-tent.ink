...
{been_tent_1 == 0: ->been_tent_1_t}
{been_tent_1 != 0: ->been_tent_1_f}

-(been_tent_1_t)

待你走近了，你才看清那顶帐篷上的红色十字：它已经被泥巴糊成灰黄。按你的经验，这应当是无国界医生的帐篷。#speaker:
你走进去，见前台正坐着一名白人女子。她瞥你一眼，给你指指桌上的一沓文件。你跟着过去看看。

[感知检定]#check:WIS+1d8>trivial

{CHECK:
-SUCCESS:那是份纸质表格，上面密密麻麻地写了两列。左边一栏混杂着各种语言，大多是拉丁文，还有些简洁的中文汉字，显然都是姓名；右边则是日期，即便国籍和语言差异巨大，这些阿拉伯数字仍然整齐划一地标注着今日。
-HUGE_SUCCESS:那是份纸质表格，上面密密麻麻地写了两列。左边一栏混杂着各种语言，大多是拉丁文，还有些简洁的中文汉字，显然都是姓名；右边则是日期，即便国籍和语言差异巨大，这些阿拉伯数字仍然整齐划一地标注着今日。
-else:那是份纸质表格，上面密密麻麻地写了两列。
}
...
你端详了一下：大的是一盒干粮，小的则是预防热带病的药物。
 ...
 [获得面包][获得阿莫西林] #object:+面包*1+阿莫西林*1
...
[智力检定]#check:INT+1d8>easy
   ...
   {CHECK:
    - FAIL: 你没能理解他们眼神中的意思。场面僵持了好一阵。 
    - HUGE_FAIL: 你没能理解他们眼神中的意思。场面僵持了好一阵。
    - SUCCESS:他们在讨钱。你意识到。
    - HUGE_SUCCESS:他们在讨钱。你意识到。
    }
